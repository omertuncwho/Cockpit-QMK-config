...
//  ),
  ...
  [_QWERTY] = LAYOUT_cockpit(
    KC_TILD,      TR_Q,  TR_W,  TR_E,  TR_R,  TR_T,                 TR_Y,  TR_U,  TR_I,  TR_O,    TR_P,     KC_BSPC,
    KC_ESC,    TR_A,  TR_S,  TR_D,  TR_F,  TR_G,                 TR_H,  TR_J,  TR_K,     TR_L,    KC_SCLN,  KC_QUOT,
    LSFT_CAPS,   TR_Z,  TR_X,  TR_C,  TR_V,  TR_B,                 TR_N,  TR_M,  KC_COMM,  KC_DOT,  KC_SLSH,  RSFT_ENT,
                                                  KC_MPLY,   KC_MUTE,
                 KC_LCTL,    KC_LGUI, KC_LALT,                          FNR_SPC,   RAISE,  LOWER,     
                                                         KC_UP,
                                            KC_LEFT,    KC_DOWN,  KC_RGHT
...
// QWERTY (omertuncwho_cockpit_keymap)
// ╭──────┬──────┬──────┬──────┬──────┬──────╮                   ╭──────┬──────┬──────┬──────┬──────┬──────╮
...
//   [_QWERTY] = LAYOUT_cockpit(
//     KC_TILD,      TR_Q,  TR_W,  TR_E,  TR_R,  TR_T,                 TR_Y,  TR_U,  TR_IDOT,  TR_O,    TR_P,     KC_BSPC,
//     KC_ESC,    TR_A,  TR_S,  TR_D,  TR_F,  TR_G,                 TR_H,  TR_J,  TR_K,     TR_L,    TR_SCLN,  TR_QUOT,
//     LSFT_SHIFT,   TR_Z,  TR_X,  TR_C,  TR_V,  TR_B,                 TR_N,  TR_M,  TR_COMM,  TR_DOT,  TR_SLSH,  RSFT_ENT,
//                                                  KC_MPLY,   KC_MUTE,
//                  KC_LCTL,   LOWER,    KC_ALT,                           FNR_SPC,   RAISE,   KC_RGUI,    
//                                                          KC_UP,
//                                             KC_LEFT,    KC_DOWN,  KC_RGHT
